...
public class SynchronizeJobProviderKontoauszugFidorCSV<T extends SynchronizeJobProvider> implements SynchronizeJobProviderFidorCSV
{
  @Resource
  ...
  {{
    add(SynchronizeJobKontoauszugFidorCSV.class);
  }};
  ...
  public boolean supports(Class<? extends SynchronizeJob> type, Konto k) {
    try {
      Logger.info(type.getCanonicalName() + " " + k.getBLZ());
    } catch (RemoteException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
  	// TODO Auto-generated method stub
  	return SynchronizeJobFidorCSV.class.isAssignableFrom(type);
  }
